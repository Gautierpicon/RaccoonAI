    ...
    return (
      <div className="mb-6 mx-4 bg-gray-100/50 backdrop-blur-sm p-4 rounded-xl border border-gray-200 shadow-sm">
        <select
          ...
          className="w-full bg-gray-200/75 text-gray-900 px-4 py-3 rounded-lg border border-transparent focus:outline-none focus:border-emerald-700 focus:ring-2 focus:ring-emerald-700/30 font-mono transition-all"
        >
          {models.map((model) => (
